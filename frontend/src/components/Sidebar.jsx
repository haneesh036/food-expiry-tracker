...
const Sidebar = ({ isOpen, onClose, handleLogout }) => {
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-slate-100 shadow-2xl lg:shadow-none transform transition-transform duration-300 ease-in-out flex flex-col",
